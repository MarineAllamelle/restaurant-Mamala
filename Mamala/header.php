...
<html lang="en">
<head>
<link rel="icon" type="image/png" sizes="32x32" href="img/logomama.png">    <!--favicon-->
<title>Mamala</title>
<meta charset="utf-8">
		...
		<strong><em>Mamala</em></strong>
            ...
            <div class="collapse navbar-collapse" id="navi">
                <ul class="navbar-nav mr-auto">
                    ...
                    <?php
                    //set navigation bar when logged in CLIENT
                    ...
                    //main page not logged in navigation bar ACCUEIL
                    else { echo'
                    <li class="nav-item">
	                    <a class="nav-link" href="#aboutus">Our Concept</a>
	                </li>
	                <li class="nav-item">
	                    <a class="nav-link" href="#galery">Hmmmm</a>
	                </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#reservation">Book your Chef</a>
                    </li>
                    <li class="nav-item">
